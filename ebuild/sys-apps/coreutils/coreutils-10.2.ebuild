...
src_install() {
	...
	dosym coreutils /bin/b2sum
	dosym coreutils /bin/md5sum
	dosym coreutils /bin/sha1sum
	dosym coreutils /bin/sha224sum
	dosym coreutils /bin/sha256sum
	dosym coreutils /bin/sha384sum
	dosym coreutils /bin/sha512sum

	use selinux && dosym coreutils /bin/chcon
	use selinux && dosym coreutils /bin/runcon
	use selinux && dosym coreutils /bin/stty
}
